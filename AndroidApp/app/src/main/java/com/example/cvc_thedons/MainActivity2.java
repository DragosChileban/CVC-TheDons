...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceBtn = findViewById(R.id.services);
        ...
        serviceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String DigPret = Pret.replaceAll("[^\\\\.0123456789]","");
                int pretInt = Integer.parseInt(DigPret);
                i.putExtra("Cost", pretInt);
                startActivity(i);
            }
        });
    ...
    public void connectServer() {
        ...
        RequestBody postBodyImage = new MultipartBody.Builder()
                ...
                .addFormDataPart("image", "damageImage.jpg", RequestBody.create(MediaType.parse("image/*jpg"), byteArray))
                .build();
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        TextView responseText = findViewById(R.id.responseText);
                        try {
                            Pret = response.body().string();
                            responseText.setText(Pret);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
